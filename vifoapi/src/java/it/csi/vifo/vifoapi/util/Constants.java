...
public class Constants {
     ...
     */
    public final static String COMPONENT_NAME = "vifoapi";
    /**
     * The constant LOGGER_NAME.
     */
    public final static String LOGGER_NAME = "vifoapi";
 	...
 	public static class URL
 	  {
 	    ...
 	    public final static String URL_BASE = "URL_BASE";
 	    public final static String URL_INSERT = "URL_INSERT";
