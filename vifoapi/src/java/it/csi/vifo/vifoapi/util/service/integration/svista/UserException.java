...
public class UserException  extends CSIException  implements Serializable {
    ...
    private static TypeDesc typeDesc =
        new TypeDesc(UserException.class, true);

    static {
        typeDesc.setXmlType(new QName("ente", "UserException"));
    }
