...
public class SystemException  extends CSIException  implements Serializable {
    ...
    private static TypeDesc typeDesc =
        new TypeDesc(SystemException.class, true);

    static {
        typeDesc.setXmlType(new QName("ente", "SystemException"));
    }
